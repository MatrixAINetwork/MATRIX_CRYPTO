...
Cryptography Library for MATRIX Network
...
```go
import "github.com/MatrixAINetwork/MATRIX_CRYPTO/MATRIXCRYPTO/keypair"
...
* as for ECDSA, it indicates the curve which could be one of:
...
well as a specified signature scheme. Note that the signature scheme should
...
```go
import "github.com/MatrixAINetwork/MATRIX_CRYPTO/MATRIXCRYPTO/signature"
...
MATRIX_CRYPTO is under LGPL v3.0 license. See [LICENSE](LICENSE) for details.
